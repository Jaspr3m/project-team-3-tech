const emailInput = document.querySelector(".email");
        ...
        emailInput.addEventListener("blur", () => {
            ...
            if (emailRegex.test(email)) {
                emailFeedback.textContent = "E-mail is geldig";
                emailFeedback.className = "feedback valid";
            } else {
                emailFeedback.textContent = "E-mail is ongeldig";
        ...
        passwordInput.addEventListener("blur", () => {
            ...
            if (password.length >= 6) {
                passwordFeedback.textContent = "Wachtwoord is geldig";
                passwordFeedback.className = "feedback valid";
            } else {
                passwordFeedback.textContent = "Wachtwoord is ongeldig (minimaal 6 tekens)";
        ...
        showPasswordButton.addEventListener("click", () => {
            if (passwordInput.type === "password") {
                ...
                showPasswordButton.innerHTML = noShowIcon;
            } else {
                passwordInput.type = "password";
                showPasswordButton.innerHTML = showIcon;
            }
        });